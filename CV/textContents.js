    ...
    "University of Florida": {
      ...
      "Honors and Achievements": {
        ...
        list: [
          ...
          "Member of the Phi Kappa Phi Honors Society"
        ]
      },
      "Classes": {
        type: SUBENTRY,
  ...
  "EMPLOYEMENT": {
    ...
    "L3Harris Technologies": {
      ...
      "Role Description": {
        type: SUBENTRY,
        text: `
          In my role as a Specialist Software Engineer, I am entrusted with a
          diverse array of responsibilities, requiring me to adeptly fulfill
          multiple roles and assume leadership positions across various projects
          and teams.
        `,
        list: [
          "Product Owner for 3 different actively deployed technologies to customer sites.",
          "Technical lead managing and assigning tasking for 9 engineers and scientists."
        ]
      },
